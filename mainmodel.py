...
model.add(LSTM(hidden_size, recurrent_dropout=0.4, dropout=0.4, return_sequences=True))
model.add(Dense(vocab, activation='tanh'))
model.add(LSTM(hidden_size, recurrent_dropout=0.4, dropout=0.4, return_sequences=False))
...
input_text = "Why is it doing this"
